...
/**
 * Implements the INPUT TYPE=SUBMIT html tag
 * 
 * @package Sylar
 * @version 1.0
 * @since 14/mag/08
...
class Sylar_FormInputSubmit extends Sylar_FormComponent{

	
	function __construct($sId=null, $Value=null, $sOnClick=null){
