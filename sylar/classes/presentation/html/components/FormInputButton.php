...
/**
 * Implements the INPUT TYPE=TEXT html tag
 * 
 * @package Sylar
 * @version 1.0
 * @since 14/mag/08
...
class Sylar_FormInputButton extends Sylar_FormComponent{

	
	function __construct($sId=null, $sName=null, $Value=null, $sOnClick=null){
