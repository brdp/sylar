...
/**
 * Implements the INPUT TYPE=FILE html tag
 * 
 * REMEMBER! It's usable only if the form ENCTYPE is set to "multipart/form-data" and METHOD is post
 * 
 * @see Sylar_Form
 * 
 * @package Sylar
...
class Sylar_FormInputFile extends Sylar_FormComponent{

	
	function __construct($sId=null, $sName=null, $sSize=null){
