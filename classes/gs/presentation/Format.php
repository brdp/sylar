...
/**
 * Main Format Class for GS Format Classes
 * 
 * Main Class for formatting output in your Application using GS objects. 
...
class GS_Format extends Sylar_Format{
	...
	public function widgetErrorMessage($errorCode, $divName="sylar_ErrorWidgt", $errorMessage=null, $errorTitle=null){
		...
		switch ($errorCode) {
			case 20023:
				$tit = $this->translate("Skvr_Err_20023_tit");
				$msg = $this->translate("Skvr_Err_20023_msg");
				break;
			
			default:
				$tit = $this->translate("Skvr_Err_GENERIC_tit");
				$msg = $this->translate("Skvr_Err_GENERIC_msg");
				break;
		}
