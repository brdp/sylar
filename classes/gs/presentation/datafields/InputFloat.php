...
class GS_InputFloat extends GS_DataField{

	private $cDecimalSeparator=".";
	private $iIntegerDigits=10;
	private $iDecimalDigits=5;
	...
	public function getIntegerDigits() {
		return $this->iIntegerDigits;
	}
	/**
	 * Set the integer digits number
	 *
	 * @param int $iIntegerDigits
	 */
	public function setIntegerDigits($iIntegerDigits) {
		$this->iIntegerDigits = $iIntegerDigits;
	}
	/**
	 * get the decimal digits number
	 *
	 * @return integer
	 */
	public function getDecimalDigits() {
		return $this->iDecimalDigits;
	}
	/**
	 * Set the decimal digits number
	 *
	 * @param integer $iDecimalDigits
	 */
	public function setDecimalDigits($iDecimalDigits) {
		$this->iDecimalDigits = $iDecimalDigits;
	}		
	...
	private function prepareFormField(){
		...
		$inputSource = $formF1->getHtmlSource().$this->getDecimalSeparator().$formF2->getHtmlSource()."".$formFx->getHtmlSource();
