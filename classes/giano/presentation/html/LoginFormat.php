...
import('app.giano.logic.LoginEngine');
...
class App_LoginFormat extends App_Format{
	...
	public function makeLoggedInWidget(){
		$engine = new App_LoginEngine();
		$oHD = new Sylar_HtmlDiv("LoginWidget", null, "logged");
		$sDivContent = "
			<fieldset style=\"text-align:left;\">
			<legend><b>USER LOGGED!!!</b></legend>
			<i>".$engine->extractUserInfo()."</i>
			<br>Perform LOGOUT...
			</fieldset>";
		$oHD->appendContent($sDivContent);
		
		return $oHD;
	}
	
	
	public function makeLoggedOffWidget(){
		$engine = new App_LoginEngine();
		$oHD = new Sylar_HtmlDiv("LogOffWidget", null, "not-logged");
		$sDivContent = "
			<fieldset style=\"text-align:left;\">
			<legend><b>USER NOT LOGGED</b></legend>
			Perform LOGIN...
			</fieldset>";		
		$oHD->appendContent($sDivContent);
